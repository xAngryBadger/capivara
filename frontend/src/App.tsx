  ...
  return (
    <>
      ...
      >
        ...
        <header className={`fixed left-0 right-0 z-40 h-16 flex items-center transition-top duration-300 ${bannerVisible ? 'top-[76px]' : 'top-0'}`} style={{ backdropFilter: 'blur(16px)', backgroundColor: 'rgba(11,15,25,0.8)' }}>
